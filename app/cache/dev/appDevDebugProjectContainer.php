...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator.default')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('prestashop.router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters') => 'AdvancedParameters', ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form') => NULL)), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array(($this->targetDirs[2].'/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters') => 'AdvancedParameters', ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form') => NULL))), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 7 => $this->get('main.warmer.cache_warmer'), 8 => new \Csa\Bundle\GuzzleBundle\Description\CacheWarmer\DescriptionCacheWarmer($this->get('csa_guzzle.description_factory'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop', 'user' => 'admin', 'password' => 'azerty123', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6df062eb0cd53c0b941a26bba77a49f01e9fb356eb0db0a96806315202dd97af');
    ...
    {
        return $this->services['form.type.performance.caching'] = new \PrestaShopBundle\Form\Admin\AdvancedParameters\Performance\CachingType($this->get('translator'));
    }
    ...
    {
        return $this->services['prestashop.adapter.check_requirements'] = new \PrestaShop\PrestaShop\Adapter\Requirement\CheckRequirements($this->get('translator'));
    }
    ...
    {
        return $this->services['prestashop.adapter.module.prestatrust.checker'] = new \PrestaShop\PrestaShop\Adapter\Module\PrestaTrust\PrestaTrustChecker($this->get('doctrine.cache.provider'), $this->get('prestashop.addons.client_api'), $this->get('translator'));
    }
    ...
    {
        $this->services['prestashop.core.admin.data_provider.module_interface'] = $instance = new \PrestaShop\PrestaShop\Adapter\Module\AdminModuleDataProvider($this->get('translator'), $this->get('logger'), $this->get('prestashop.core.admin.data_provider.addons_interface'), $this->get('prestashop.categories_provider'), $this->get('prestashop.adapter.data_provider.module'), $this->get('doctrine.cache.provider'), $this->get("prestashop.adapter.legacy.context")->getContext()->employee);
    ...
    {
        $this->services['prestashop.core.admin.module.repository'] = $instance = new \PrestaShop\PrestaShop\Core\Addon\Module\ModuleRepository($this->get('prestashop.core.admin.data_provider.module_interface'), $this->get('prestashop.adapter.data_provider.module'), $this->get('prestashop.core.module.updater'), $this->get('prestashop.adapter.legacy.logger'), $this->get('translator'), $this->get("prestashop.adapter.legacy.configuration")->get("_PS_MODULE_DIR_"), $this->get('doctrine.cache.provider'));
    ...
    {
        return $this->services['prestashop.module.zip.manager'] = new \PrestaShop\PrestaShop\Adapter\Module\ModuleZipManager($this->get('filesystem'), $this->get('translator'), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d = new \Symfony\Component\HttpKernel\DataCollector\ConfigDataCollector('PrestaShop', $this->get("prestashop.adapter.legacy.configuration")->get("_PS_VERSION_"));
        $d->setKernel($b);
        ...
        $instance->add($c);
        $instance->add(new \PrestaShopBundle\DataCollector\HookDataCollector($this->get('prestashop.hooks_registry')));
    ...
    {
        $this->services['translator.default'] = $instance = new \PrestaShopBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json'), 'prestashop.translation.database_loader' => array(0 => 'db')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'fr-FR' => array(0 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShippingNotification.fr-FR.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopPdf.fr-FR.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminModulesFeature.fr-FR.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminOrderscustomersNotification.fr-FR.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCustomersigninAdmin.fr-FR.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCustomtextAdmin.fr-FR.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesNewproductsShop.fr-FR.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSearchbarShop.fr-FR.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatscarrierAdmin.fr-FR.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDataprivacyShop.fr-FR.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNotificationsWarning.fr-FR.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminGlobal.fr-FR.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesImagesliderAdmin.fr-FR.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsstockAdmin.fr-FR.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSearchbarAdmin.fr-FR.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeGlobal.fr-FR.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesGAnalyticsAdmin.fr-FR.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminStatsHelp.fr-FR.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminCatalogNotification.fr-FR.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesContactinfoAdmin.fr-FR.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDashproductsAdmin.fr-FR.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/fr-FR/EmailsSubject.fr-FR.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesNewsletterAdmin.fr-FR.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNavigationSearch.fr-FR.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesFeaturedproductsShop.fr-FR.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDesignHelp.fr-FR.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopNotificationsError.fr-FR.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatssalesAdmin.fr-FR.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminCatalogHelp.fr-FR.xlf'), 29 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesFacetedsearchAdmin.fr-FR.xlf'), 30 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDateofdeliveryAdmin.fr-FR.xlf'), 31 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesEmailsubscriptionAdmin.fr-FR.xlf'), 32 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShippingFeature.fr-FR.xlf'), 33 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLegalcomplianceShop.fr-FR.xlf'), 34 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSocialfollowShop.fr-FR.xlf'), 35 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesFeederAdmin.fr-FR.xlf'), 36 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCashondeliveryShop.fr-FR.xlf'), 37 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesReminderAdmin.fr-FR.xlf'), 38 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSharebuttonsShop.fr-FR.xlf'), 39 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminActions.fr-FR.xlf'), 40 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesMailalertsShop.fr-FR.xlf'), 41 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminStatsFeature.fr-FR.xlf'), 42 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsnewsletterAdmin.fr-FR.xlf'), 43 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopNotificationsInfo.fr-FR.xlf'), 44 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLivetranslationShop.fr-FR.xlf'), 45 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopFormsHelp.fr-FR.xlf'), 46 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminModulesHelp.fr-FR.xlf'), 47 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShopparametersHelp.fr-FR.xlf'), 48 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminPaymentNotification.fr-FR.xlf'), 49 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesWirepaymentAdmin.fr-FR.xlf'), 50 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCustomeraccountlinksAdmin.fr-FR.xlf'), 51 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesFacetedsearchShop.fr-FR.xlf'), 52 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsforecastAdmin.fr-FR.xlf'), 53 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestsuppliersAdmin.fr-FR.xlf'), 54 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCarriercomparisonAdmin.fr-FR.xlf'), 55 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminAdvparametersHelp.fr-FR.xlf'), 56 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminAdvparametersNotification.fr-FR.xlf'), 57 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNotificationsInfo.fr-FR.xlf'), 58 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesRssfeedShop.fr-FR.xlf'), 59 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeCustomerAccount.fr-FR.xlf'), 60 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCurrencyselectorAdmin.fr-FR.xlf'), 61 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesShoppingcartAdmin.fr-FR.xlf'), 62 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesWirepaymentShop.fr-FR.xlf'), 63 => ($this->targetDirs[2].'/Resources/translations/fr-FR/EmailsBody.fr-FR.xlf'), 64 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShopparametersFeature.fr-FR.xlf'), 65 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSupplierlistAdmin.fr-FR.xlf'), 66 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestvouchersAdmin.fr-FR.xlf'), 67 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopFormsErrors.fr-FR.xlf'), 68 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBestsellersShop.fr-FR.xlf'), 69 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestmanufacturersAdmin.fr-FR.xlf'), 70 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestcustomersAdmin.fr-FR.xlf'), 71 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatscatalogAdmin.fr-FR.xlf'), 72 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsequipmentAdmin.fr-FR.xlf'), 73 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopNavigation.fr-FR.xlf'), 74 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBlockreassuranceShop.fr-FR.xlf'), 75 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCarriercomparisonShop.fr-FR.xlf'), 76 => ($this->targetDirs[2].'/Resources/translations/fr-FR/Install.fr-FR.xlf'), 77 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCrosssellingShop.fr-FR.xlf'), 78 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesEmailsubscriptionShop.fr-FR.xlf'), 79 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesWelcomeAdmin.fr-FR.xlf'), 80 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBrandlistAdmin.fr-FR.xlf'), 81 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminOrderscustomersHelp.fr-FR.xlf'), 82 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesMailalertsAdmin.fr-FR.xlf'), 83 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsvisitsAdmin.fr-FR.xlf'), 84 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsproductAdmin.fr-FR.xlf'), 85 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeActions.fr-FR.xlf'), 86 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDesignFeature.fr-FR.xlf'), 87 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNavigationMenu.fr-FR.xlf'), 88 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSharebuttonsAdmin.fr-FR.xlf'), 89 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSupplierlistShop.fr-FR.xlf'), 90 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSekeywordsAdmin.fr-FR.xlf'), 91 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBrandlistShop.fr-FR.xlf'), 92 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesViewedproductShop.fr-FR.xlf'), 93 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDashboardFeature.fr-FR.xlf'), 94 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestcategoriesAdmin.fr-FR.xlf'), 95 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesTrackingfrontAdmin.fr-FR.xlf'), 96 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCategorytreeAdmin.fr-FR.xlf'), 97 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDashgoalsAdmin.fr-FR.xlf'), 98 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminAdvparametersFeature.fr-FR.xlf'), 99 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsliveAdmin.fr-FR.xlf'), 100 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesRssfeedAdmin.fr-FR.xlf'), 101 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsdataAdmin.fr-FR.xlf'), 102 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDashboardNotification.fr-FR.xlf'), 103 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDesignNotification.fr-FR.xlf'), 104 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminModulesNotification.fr-FR.xlf'), 105 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatssearchAdmin.fr-FR.xlf'), 106 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminInternationalFeature.fr-FR.xlf'), 107 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesContactformShop.fr-FR.xlf'), 108 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminPaymentFeature.fr-FR.xlf'), 109 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopDemoCatalog.fr-FR.xlf'), 110 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesViewedproductAdmin.fr-FR.xlf'), 111 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminInternationalNotification.fr-FR.xlf'), 112 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopFormsLabels.fr-FR.xlf'), 113 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminOrderscustomersFeature.fr-FR.xlf'), 114 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShippingHelp.fr-FR.xlf'), 115 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCrosssellingAdmin.fr-FR.xlf'), 116 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSocialfollowAdmin.fr-FR.xlf'), 117 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSpecialsAdmin.fr-FR.xlf'), 118 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesFeaturedproductsAdmin.fr-FR.xlf'), 119 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDashtrendsAdmin.fr-FR.xlf'), 120 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeCheckout.fr-FR.xlf'), 121 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLanguageselectorAdmin.fr-FR.xlf'), 122 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesNewproductsAdmin.fr-FR.xlf'), 123 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesContactinfoShop.fr-FR.xlf'), 124 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCheckpaymentShop.fr-FR.xlf'), 125 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesTrackingfrontShop.fr-FR.xlf'), 126 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsregistrationsAdmin.fr-FR.xlf'), 127 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminStatsNotification.fr-FR.xlf'), 128 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesContactformAdmin.fr-FR.xlf'), 129 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsbestproductsAdmin.fr-FR.xlf'), 130 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesSpecialsShop.fr-FR.xlf'), 131 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesMainmenuAdmin.fr-FR.xlf'), 132 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNotificationsSuccess.fr-FR.xlf'), 133 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminDashboardHelp.fr-FR.xlf'), 134 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNotificationsError.fr-FR.xlf'), 135 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesAutoupgradeAdmin.fr-FR.xlf'), 136 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLivetranslationAdmin.fr-FR.xlf'), 137 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatsoriginAdmin.fr-FR.xlf'), 138 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatspersonalinfosAdmin.fr-FR.xlf'), 139 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesGraphnvd3Admin.fr-FR.xlf'), 140 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeCustomeraccount.fr-FR.xlf'), 141 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesStatscheckupAdmin.fr-FR.xlf'), 142 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCategoryproductsAdmin.fr-FR.xlf'), 143 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNavigationNotification.fr-FR.xlf'), 144 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBlockreassuranceAdmin.fr-FR.xlf'), 145 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminInternationalHelp.fr-FR.xlf'), 146 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopNotificationsWarning.fr-FR.xlf'), 147 => ($this->targetDirs[2].'/Resources/translations/fr-FR/messages.fr-FR.xlf'), 148 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminLoginNotification.fr-FR.xlf'), 149 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesPagesnotfoundAdmin.fr-FR.xlf'), 150 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminCatalogFeature.fr-FR.xlf'), 151 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDateofdeliveryShop.fr-FR.xlf'), 152 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminPaymentHelp.fr-FR.xlf'), 153 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesAdvertisingAdmin.fr-FR.xlf'), 154 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesProductinfoAdmin.fr-FR.xlf'), 155 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLegalcomplianceAdmin.fr-FR.xlf'), 156 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNavigationHeader.fr-FR.xlf'), 157 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDataprivacyAdmin.fr-FR.xlf'), 158 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesDashactivityAdmin.fr-FR.xlf'), 159 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminShopparametersNotification.fr-FR.xlf'), 160 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLinklistAdmin.fr-FR.xlf'), 161 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminLoginFeature.fr-FR.xlf'), 162 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBestsellersAdmin.fr-FR.xlf'), 163 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCashondeliveryAdmin.fr-FR.xlf'), 164 => ($this->targetDirs[2].'/Resources/translations/fr-FR/AdminNavigationFooter.fr-FR.xlf'), 165 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCheckpaymentAdmin.fr-FR.xlf'), 166 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBannerAdmin.fr-FR.xlf'), 167 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesCategoryproductsShop.fr-FR.xlf'), 168 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopThemeCatalog.fr-FR.xlf'), 169 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesLinklistShop.fr-FR.xlf'), 170 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesGridhtmlAdmin.fr-FR.xlf'), 171 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ShopNotificationsSuccess.fr-FR.xlf'), 172 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesPscleanerAdmin.fr-FR.xlf'), 173 => ($this->targetDirs[2].'/Resources/translations/fr-FR/ModulesBannerShop.fr-FR.xlf')))), array());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views'), 'SensioDistribution');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('PCUJcZtKbb1pMBHmFCdFRiYpjFFVGTEuPCqfsj7aBnCGmXFVYZmW20ms');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a9e6c3f743038.87815382')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.secret' => 'PCUJcZtKbb1pMBHmFCdFRiYpjFFVGTEuPCqfsj7aBnCGmXFVYZmW20ms',
